...
- Never nest `tw:block` markers. If you split a coarse block into smaller editable blocks, remove the coarse parent block markers and wrap the child items as sibling blocks inside the unmarked container.
