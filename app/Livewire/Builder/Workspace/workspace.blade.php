...
>
    <aside class="row-span-2 border-r border-neutral-800 bg-neutral-900">
        <livewire:builder.left-sidebar.left-sidebar :project="$project" :page="$page" :block-index="$block_index" :selected-node-id="$selected_node_id" :selected-block-ids="$selected_block_ids" :key="'left-'.$page->id" />
    </aside>
