...
>
    @forelse ($events as $event)
        @php
            $isRunning = $loop->first && (($event->level === 'info' && str_ends_with((string) $event->kind, 'started')) || in_array($event->kind, ['edit_requested', 'insert_requested', 'remove_requested', 'enhance_requested'], true));
