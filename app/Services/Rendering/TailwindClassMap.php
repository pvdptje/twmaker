...
class TailwindClassMap
{
    ...
    {
        $fixed = [
            'builder-section', 'builder-node', 'mx-auto', 'px-6', 'max-w-3xl', 'max-w-5xl', 'max-w-7xl', 'max-w-full',
            'text-left', 'text-center', 'text-right', 'bg-white', 'bg-neutral-50', 'bg-neutral-100', 'bg-neutral-900',
            'text-white', 'text-neutral-950', 'text-neutral-900', 'text-neutral-700', 'text-neutral-600', 'text-blue-600',
            'bg-blue-600', 'bg-blue-50', 'border-blue-200', 'text-emerald-700', 'bg-emerald-50', 'border-emerald-200',
            'text-amber-700', 'bg-amber-50', 'border-amber-200', 'text-cyan-700', 'bg-cyan-50', 'border-cyan-200',
            'py-8', 'py-16', 'py-24', 'py-32', 'p-0', 'p-3', 'p-4', 'p-6', 'gap-2', 'gap-3', 'gap-4', 'gap-6',
            'gap-8', 'flex', 'inline-flex', 'flex-row', 'flex-col', 'flex-wrap', 'grid', 'grid-cols-1', 'grid-cols-2',
            'grid-cols-3', 'grid-cols-4', 'grid-cols-6', 'items-start', 'items-center', 'items-end', 'items-stretch',
            'justify-start', 'justify-center', 'justify-end', 'justify-between', 'rounded-none', 'rounded-sm',
            'rounded-md', 'rounded-lg', 'rounded-xl', 'rounded-full', 'border', 'border-0', 'border-t', 'border-t-2',
            'border-neutral-200', 'border-neutral-300', 'object-cover', 'object-contain', 'font-medium', 'font-semibold',
            'tracking-normal', 'leading-7', 'text-xs', 'text-sm', 'text-base', 'text-lg', 'text-xl', 'text-2xl',
            'text-3xl', 'text-5xl', 'w-full', 'max-w-full', 'px-3', 'px-4', 'py-1', 'py-2', 'pl-6', 'space-y-2',
            'list-disc', 'list-decimal', 'my-4', 'my-8', 'my-12', 'underline', 'hover:underline', 'shadow-sm',
        ];

        return array_fill_keys($fixed, true);
    }
